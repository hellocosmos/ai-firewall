...
0.38은 연결 키 또는 외부 JWT 게이트웨이 인증과 별도 대상 자격증명을 포함한 Docker Compose Preview입니다. 이미지는 소스에서 빌드하며 TrapDefense Cloud는 계획 단계입니다.
...
[Docker 0.38](self-hosting.md) · [게이트웨이 호환성](gateway-compatibility.md)
